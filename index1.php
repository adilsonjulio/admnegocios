...
<body data-spy="scroll" data-target=".navbar" data-offset="150">
  ...
  ?>
	...
	<div class="container">
	  ...
	  <li class="nav-item">
	    <a class="nav-link text-white font-weight-normal display-5 border-right" href="#">Central de Atendimento (24) 3323-1040 / 3328-6600</a>
	  </li>
	  <li class="nav-item">
	...
	<div class="container-fluid  bg-my-color-2">	
		<div class="container">
			<div class="row">
	...
	<!-- Início seção imóveis para venda -->
		<section class="" id="imoveis" class="bg-faded wow fadeInUp" data-wow-duration="0.5s" data-wow-offset="200"; style="background:#f2f2f2; padding-bottom: 20px;">
			...
			<div class="row">
					<div class="owl-carousel owl-theme">
						...
						include ("functions/limita-texto.php");
						 ...
						 $select = "SELECT * FROM imoveis WHERE tipo = 'VENDA' ORDER BY id DESC";
					...
					<div class="item">
							...
							<a href="detalhes.php?id=<?php echo $mostra->id;?>" style="text-decoration: none;">
								...
								<div class="card text-white" style="max-width: 100%; border-radius: 0; border: 0;">
								  ...
								  <p class="card-text mt-4" style="font-size: 16px; color: #212529; height: 200px"><?php echo limitarTexto($mostra->descricao, $limite=200)?></p>
								  </div>
								<div class="d-flex px-2" style="background: #D50000">
								  <div class="mr-auto p-1"class="text-muted text-uppercase" style="color: #fff !important; font-size: 20px; font-weight: 600;"><?php echo $mostra->tipo;?></div>
								<div class="p-1"class="text-muted" style="color: #fff !important; font-size: 20px; font-weight: 600;"><?php echo number_format($mostra->preco,2,',','.');?></div>
								</div>
									</div>						
							</div>
	...
	<!-- Fim seção imóveis para venda -->

	<div class="divisor-imoveis"></div>
	
	<!-- Início seção imóveis para locação  -->
		...
		<div class="container pt-4">
			...
			<div class="row">
					<div class="owl-carousel owl-theme">
						<?php
							// Fazer a seleção do banco de dados
						 $select = "SELECT * FROM imoveis WHERE tipo = 'ALUGUEL' ORDER BY id DESC";
	...
	<!-- Fim seção imóveis para locação  -->
