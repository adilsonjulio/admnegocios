   ...
   <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
            <a class="nav-link mr-4" style="color: #fff !important" href="#"><i class="fas fa-user"> <?php echo $exibe_user['nome']; ?> </i></a>
          </li>
          ...
          <?php } else { ?>
              ...
              <li class="nav-item">
                <a class="nav-link mr-4" style="color: #fff !important" href="adm.php">Administrador</a>
              </li>
