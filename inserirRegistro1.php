...
try {
	...
	$inserir=$conexao->query("INSERT INTO imoveis (lancamento, tipo, titulo, descricao, preco, foto1, foto2, foto3, foto4, foto5, foto6, foto7, foto8, foto9) VALUES ('$recebe_lancamento', '$recebe_tipo', '$recebe_titulo', '$recebe_descricao', '$recebe_preco', '$img_nome1', '$img_nome2', '$img_nome3', '$img_nome4', '$img_nome5', '$img_nome6', '$img_nome7', '$img_nome8', '$img_nome9')");
