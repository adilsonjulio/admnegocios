  ...
  ?>
	...
	<section class="" id="imoveis" class="pb-5 bg-faded wow fadeInUp" data-wow-duration="0.5s" data-wow-offset="200"; style="background:#f2f2f2; padding-bottom: 20px;">
					...
					<div class="col-sm-4 col-md-4 pl-1 pb-5">
						<div class="hoverzoom" style="box-shadow: 0 0 5px rgba(0,0,0,0.2);">
							...
							<div class="card text-white" style="max-width: 100%; border-radius: 0; border: 0;">
							  ...
							  <h5 class="card-title text-center mt-3" style="color: #000; font-weight: 600; height: 2.50rem;"><?php echo $mostra->titulo;?></h5>
							  <p class="card-text mt-4" style="font-size: 16px; color: #212529; height: 200px"><?php echo $mostra->descricao;?></p>
							  </div>
							<div class="d-flex px-2" style="background: #D50000">
							  <div class="mr-auto p-1"class="text-muted text-uppercase" style="color: #fff !important; font-size: 18px; font-weight: 600;"><?php echo $mostra->tipo;?></div>
							<div class="p-1"class="text-muted" style="color: #fff !important; font-size: 18px; font-weight: 600;"><?php echo $mostra->preco;?></div>
							</div>
								</div>						
								</a>
						</div>
		...
		<div class="paginas">
			...
			<a href="index2.php?acao=index2&pg=1">Primeira página</a>			
			...
			<a href="index2.php?acao=index2&pg=<?php echo $i;?>" class="ativo<?php echo $i;?>"><?php echo $i;?></a>

			<?php }}?>

			<a href="index2.php?acao=index2&pg=<?php echo $i;?>" class="ativo<?php echo $i;?>"><?php echo $pg;?></a>
			...
			<a href="index2.php?acao=index2&pg=<?php echo $paginas;?>" class="ativo<?php echo $i;?>">Última página</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-6 col-lg-4 pt-1 text-xs-center wow fadeInLeft" data-wow-duration="0.5s">
						...
						<p class="lead text-muted">Voc� ser� capaz de criar sites como este, acess�veis em celulares, tables, desktops ou qualquer outro tipo de tela</p>
					</div>
					<div class="col-sm-6 col-lg-4 pt-1 text-xs-center wow fadeInUp" data-wow-duration="0.5s">
						<i class="fa fa-code fa-5x"></i>
						<h3 class="my-1">Componentes BS4</h3>
						<p class="lead text-muted">Conhe�a os principais componentes do Bootstrap4 e economize tempo na execu��o de seus projetos</p>
					</div>
					...
					<div class="col-sm-6 col-lg-4 pt-1 text-xs-center wow fadeInRight" data-wow-duration="0.5s">
						...
						<p class="lead text-muted">Organize seu conte�do de maneira f�cil e responsiva utilizando, o sistema de grids do Bootstrap.</p>
					</div>

					<div class="col-sm-6 col-lg-4 pt-1 text-xs-center wow fadeInLeft" data-wow-duration="0.5s">
						<i class="fa fa-text-height fa-5x"></i>
						<h3 class="my-1">Tipografia</h3>
						<p class="lead text-muted">Aprenda a utilizar as ferramentas disponibilziadas para aplicar diversas formata��es nos textos da sua p�gina</p>
					</div>
					...
					<div class="col-sm-6 col-lg-4 pt-1 text-xs-center wow fadeInUp" data-wow-duration="0.5s">
						...
						<p class="lead text-muted">Conhe�a as formas de personaliza��o de imagens que o bootstrap oferece, e d� personalizado � sua p�gina.</p>
					</div>
					<div class="col-sm-6 col-lg-4 pt-1 text-xs-center wow fadeInRight" data-wow-duration="0.5s">
						<i class="fa fa-plus fa-5x"></i>
						<h3 class="my-1">Outros</h3>
						<p class="lead text-muted">Al�m destes, voc� ter� acesso a mais conhecimentos sobre Bootstrap4, HTML5, CSS3...</p>
					</div>
				</div>
		...
		<div class="container">
			<div class="owl-carousel owl-theme">
				<div class="item">
				<img src="img/logo_administra_padrao.png">>
				</div>
