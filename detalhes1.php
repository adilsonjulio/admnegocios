...
<div class="container-fluid no-padding img-header" style="background: #000; height: 32px;">		
    ...
    <!-- Deguste -->
    <section id="deguste" class="py-3 pt-5 bg-faded wow fadeInUp" data-wow-duration="0.5s" data-wow-offset="200">
      <div class="container">
        <div class="row mb-1">
          <div class="col-md-12 text-center">
            <h3 class="text-color1"><?php echo $row_detalhes['titulo']; ?></h3>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 no-padding">
            <img src="upload/kitnet6.jpeg" height="460" alt="" class=" img-fluid img-thumbnail mt-2" style="margin-left: 2px;">
          </div> 

          <div class="col-md-5">
              <div class="container no-padding pb-4" style="background: #fff; border-radius: 5px !important;">
                <a href="upload/<?php echo $row_detalhes['foto1']; ?>" data-caption="Image 1" data-fancybox="images">
                  <img src="upload/<?php echo $row_detalhes['foto1']; ?>" alt="" class="imgfancyBox img-fluid mt-2" style="margin-left: 2px;">
                </a>
                <a href="img/casa1-detalhe-1.jpg" data-caption="Image 1" data-fancybox="images">
                  <img src="img/casa1.jpg" alt="" class="imgfancyBox img-fluid mt-2" style="margin-left: 2px;">
                </a>
                <a href="img/casa1-detalhe-1.jpg" data-caption="Image 1" data-fancybox="images">
        ...
        <section id="vantagens" class="py-3 mt-4" style="background: #2a2c32;">
