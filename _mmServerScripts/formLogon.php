		...
		<div class="col-sm-4 col-sm-offset-4">
			...
			<form action="validaUsuario.php" method="POST" name="logon" class="form-signin">
				...
				<div class="form-group mt-3">
					...
					<input name="senha" type="password" class="form-control mt-3" required id="senha">
				</div>
				
				<button type="submit" style="cursor: pointer" class="btn btn-outline-danger btn-lg btn-block mt-5">
					<span class="glyphicon glyphicon-ok">Acessar</span>
				</button>
           
            <a href="formUsuario.php">
				<button type="submit" class="btn btn-lg btn-link mt-4" style="cursor: pointer;">
