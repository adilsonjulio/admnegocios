...
if (isset($_POST['usuario'])) {
  ...
  $LoginRS = mysql_query($LoginRS__query, $administranego) or die(mysql_error());
...
<div class="container my-5 pt-5">
	...
	<div class="row justify-content-md-center pt-5 mt-5">
		<div class="col-sm-2 col-sm-offset-4 text-center">
				<a href="adm.php" style="cursor: pointer" class="btn btn-outline-danger btn-block">
					<span class="glyphicon glyphicon-ok">Voltar</span>
			</a>	
		</div>
	</div>	
</div>	
